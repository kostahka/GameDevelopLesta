...
public:
    virtual ~engine();
    virtual return_code initialize(std::ostream& error_stream) = 0;
    virtual return_code uninitialize()                         = 0;
    virtual void        set_game(game*)                        = 0;

    virtual return_code dev_initialization(std::string lib_name,
                                           std::string tmp_lib_name) = 0;
    virtual return_code start_dev_game_loop()                        = 0;
